...
num_examples_per = 20
output_size = 100
num_domains = [1, 2, 4, 10]
num_runs = 100 
learning_rate = 0.01
num_epochs = 2000
batch_size = 1
filename_prefix = "orthogonal_transform_results/"
...
for run_i in xrange(num_runs):
  for num_dom in num_domains:
      ...
      x_data, y_data = datasets.transformed_dataset(num_examples_per, output_size, num_dom) 
	  ...
	  with open(filename_prefix + "loss_ndom%i_run%i.csv" % (num_dom, run_i), "w") as fout:
