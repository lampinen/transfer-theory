...
N_2_bars = [1, 3]
singular_value_multipliers = [1.] # [0.84, 2.,  4., 6., 8.]
            ...
            for singular_value_multiplier in singular_value_multipliers:
                for aligned in [True, False]:
                    for output_size in output_sizes:
                        ...
                        print("Now running N_2_bar: %i, noise_var: %.2f, output_size: %i, svm: %f, alignment: %s, run: %i" % (N_2_bar, noise_var, output_size, singular_value_multiplier, aligned, run_i))
