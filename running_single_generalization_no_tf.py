...
filename_prefix = "randomizing_data_results/"
                ...
                for singular_value_multiplier in singular_value_multipliers:
                    for aligned in [False]:
                        for output_size in output_sizes:
                            ...
                            print("Now running randomized: %r N_2_bar: %i, noise_var: %.2f, output_size: %i, svm: %f, alignment: %s, run: %i" % (randomized, N_2_bar, noise_var, output_size, singular_value_multiplier, aligned, run_i))
                            ...
                            np.savetxt(filename_prefix + "rand_%r_n2b_%i_noise_var_%.2f_output_size_%i_svm_%f_aligned_%s_run_%i_y_data.csv"% (randomized, N_2_bar, noise_var, output_size, singular_value_multiplier, aligned, run_i), y_data, delimiter=",")
                            np.savetxt(filename_prefix + "rand_%r_n2b_%i_noise_var_%.2f_output_size_%i_svm_%f_aligned_%s_run_%i_noisy_y_data.csv"% (randomized, N_2_bar, noise_var, output_size, singular_value_multiplier, aligned, run_i), noisy_y_data, delimiter=",")
                            np.savetxt(filename_prefix + "rand_%r_n2b_%i_noise_var_%.2f_output_size_%i_svm_%f_aligned_%s_run_%i_noisy_y_data_spectrum.csv"% (randomized, N_2_bar, noise_var, output_size, singular_value_multiplier, aligned, run_i), np.linalg.svd(noisy_y_data, compute_uv=False), delimiter=",")
                            if input_type != "one_hot":
                              np.savetxt(filename_prefix + "rand_%r_n2b_%i_noise_var_%.2f_output_size_%i_svm_%f_aligned_%s_run_%i_x_data.csv"% (randomized, N_2_bar, noise_var, output_size, singular_value_multiplier, aligned, run_i), x_data, delimiter=",")
                            ...
                            if track_SVD:
                                fsvd = open(filename_prefix + "rand_%r_n2b_%i_noise_var_%.2f_output_size_%i_svm_%f_aligned_%s_run_%i_SVD_track.csv" % (randomized, N_2_bar, noise_var, output_size, singular_value_multiplier, aligned, run_i), "w")
                            ...
                            with open(filename_prefix + "rand_%r_n2b_%i_noise_var_%.2f_output_size_%i_svm_%f_aligned_%s_run_%i.csv" % (randomized, N_2_bar, noise_var, output_size, singular_value_multiplier, aligned, run_i), "w") as fout:
