...
```{r}
p = ggplot(data=avg_d %>% filter(grepl("Empirical", type), epoch %% 200 == 0), aes(x=epoch/1000, y=log_tr_loss, color=as.numeric(levels(svm)[svm]), group=interaction(new_type, svm, student_rank))) +
