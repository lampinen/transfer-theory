...
num_epochs = 5000
batch_size = 30
filename_prefix = "shared_input_mode_ortho_inputs_results/"
  ...
  for num_dom in num_domains:
      for q in qs:
          ...
          if input_type == "one_hot":
              ...
              x_data, y_data, noisy_y_data, input_modes = datasets.noisy_shared_input_modes_dataset_different_inputs(num_examples, output_size, num_dom, q, noise_var=noise_var, input_type=input_type) 
