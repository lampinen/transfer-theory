...
\begin{frame}[standout]
Caveat: This assumes the student is initialized with weak Teacher Aligned (TA) modes.\\[1em]
We'll show it closely approximates the results for random initializations.
\end{frame}
