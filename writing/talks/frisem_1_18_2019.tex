...
This is partly because they're based on binary classification, and modern tasks are more interesting (especially for cognitive models).
\end{frame}
...
\begin{frame}[standout]
Randomized data is learned slower because the variance of strong signal modes is spread out fairly uniformly, and the strongest modes are learned first. 
\end{frame}
...
\begin{frame}{Is gradient descent (+ regularization) optimal?}
\end{frame}
